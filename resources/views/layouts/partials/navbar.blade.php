        ...
        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
            ...
            <a class="dropdown-item d-flex align-items-center" href="#">
                <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="{{ Vite::asset('resources/images/undraw_profile_1.svg')}}"
                        alt="...">
            ...
            <a class="dropdown-item d-flex align-items-center" href="#">
                <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="{{ Vite::asset('resources/images/undraw_profile_2.svg')}}"
                        alt="...">
            ...
            <a class="dropdown-item d-flex align-items-center" href="#">
                <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="{{ Vite::asset('resources/images/undraw_profile_3.svg')}}"
                        alt="...">
    ...
    @if (Auth::check())
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
            ...
            <img class="img-profile rounded-circle"
                src="{{ Vite::asset('resources/images/pp-arief.jpg')}}" 
        </a>
        @else
        <a
              href="{{ route('register') }}"
